...
const COMPARISON: [string, Mark, Mark][] = [
  ...
  ["3-day consecutive deficiency alert", "yes", "no"],
  ["Board notification trigger", "yes", "no"],
  ["2-year record retention", "yes", "no"],
  ["Nevada R113-24 documentation", "yes", "no"],
  ["Certified vs. non-certified tech tracking", "roadmap", "no"],
